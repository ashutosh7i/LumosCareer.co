...
export default function Component() {
  ...
  const [showLinksBadge, setShowLinksBadge] = useState(false);
  const [showAdditionalInfoBadge, setShowAdditionalInfoBadge] = useState(false);
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>
                      we generate resume using your previously fed data
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex items-center">
                    <div className="grid w-full max-w-sm items-center gap-1.5">
                      ...
                      <Button size={"sm"} onClick={generateNewResume}>
                        Generate again 🔂
                      </Button>
                    </div>
                  </div>
